...
{
	CMatrix ma,mat(this->mt),m_zero(this->r_size());
	CVector vec1(this->r_size()),vec2(this->r_size());
	ma.assign(this->r_size());
	ma.IdentifyMatrix();

	int i,j;
	for(i=0;i<this->r_size()-1;i++)
	{
		if(mat[i][i]==0)
		{
